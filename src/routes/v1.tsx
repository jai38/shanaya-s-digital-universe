...
export const Route = createFileRoute("/v1")({
  head: () => ({
    meta: [
      { title: "Shanaya Kacheria ΓÇö Singer ΓÇó Songwriter ΓÇó Composer ΓÇó DJ" },
      ...
      { property: "og:description", content: "Music that doesn't just sound meaningful ΓÇö it feels meaningful." },
    ],
  }),
  component: Index,
});
  ...
  return (
    <>
      ...
      <section ref={ref} className="relative isolate min-h-[100svh] overflow-hidden">
        ...
        <div className="mx-auto flex min-h-[100svh] max-w-7xl flex-col justify-between px-5 pb-10 pt-10 md:px-8 md:pt-16">
          <div className="flex items-center gap-3">
            ...
            <Sticker variant="magenta" rotate={6}>now playing Γùë</Sticker>
          </div>
          ...
          <div className="my-10">
            ...
            >
              ΓÇö Shanaya Kacheria ┬╖ b. Mumbai ┬╖ ear for the unsaid
            </motion.p>
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <p className="max-w-md text-base text-foreground/80 md:text-lg">
              An artist obsessed with the space <em className="text-gradient not-italic">between</em> sound and feeling ΓÇö how a melody holds memory, how rhythm bends mood.
            </p>
      ...
      <section className="border-y border-border bg-ink py-6">
        <Marquee>
          {["singer", "Γ£ª", "songwriter", "Γ£ª", "composer", "Γ£ª", "dj", "Γ£ª", "performer", "Γ£ª", "trinity grade 8", "Γ£ª", "berklee selected", "Γ£ª"].map((w, i) => (
            <span key={i} className="font-display text-3xl md:text-5xl">
              {w === "Γ£ª" ? <span className="text-gradient">{w}</span> : w}
            </span>
          ))}
        </Marquee>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-5 py-24 md:px-8 md:py-40">
        <Reveal>
          <p className="font-mono text-xs uppercase tracking-[0.3em] text-muted-foreground">ΓÇö chapter 01 / the why</p>
        </Reveal>
        <Reveal delay={0.1}>
          <p className="font-display mt-6 text-3xl leading-tight tracking-tight text-balance md:text-5xl lg:text-6xl">
            ...
            the loud ones, the ones we don't have words for yet ΓÇö they all get a chord, a verse, a beat.
          </p>
        </Reveal>
        ...
        <div className="mt-20 grid gap-6 md:grid-cols-3">
          {[
            ...
            { t: "25/India", l: "Selected ┬╖ GMI ├ù Berklee workshop" },
      ...
      <section className="mx-auto max-w-7xl px-5 pb-32 md:px-8">
        <Reveal>
          <p className="font-mono text-xs uppercase tracking-[0.3em] text-muted-foreground">ΓÇö take a tour</p>
          <h2 className="font-display mt-4 text-4xl md:text-6xl">pick a track <span className="text-gradient italic">Γåô</span></h2>
        </Reveal>
        ...
        <div className="mt-12 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {[
            ...
            { to: "/mind", n: "05", t: "Music & Mind", d: "Why sound moves us ΓÇö the psychology bit." },
